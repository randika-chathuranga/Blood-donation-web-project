     ...
     <div class="slider">
        ...
        <div class="owl-carousel ">
            <div class="slider-img">
                <div class="item">
                    <div class="slider-img"><img src="public/images/slider/slider-3.jpg" alt=""></div>
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                                <div class="animated bounceInDown slider-captions">
                                    <h1 class="slider-title">Blood is a life, pass it on!</h1>
            ...
            <div class="item">
                <div class="slider-img"><img src="public/images/slider/slider-1.jpg" alt=""></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                            <div class="slider-captions ">
                                <h1 class="slider-title">Donate your blood for a reason, let the reason <br> to be life</h1>
                                <p class="slider-text hidden-xs">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
            ...
            <div class="item">
                <div class="slider-img"><img src="public/images/slider/slider-2.jpg" alt=""></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                            <div class="slider-captions ">
    ...
    <div class="about-us" id="about_us">
        <div class="container">
            ...
            <div class="about-row row">
                ...
                <div class="col-md-4">
                    <img src="public/images/about_img.png" alt="">
                </div>
            </div>
        </div>
    </div>
     ...
     <section class="container-fluid causes" id="process">
        ...
        <div class="cuses-row row">
            ...
            <div class="col-md-3">
                ...
                <div class="caus-img">
                    <img src="public/images/causes/c2.jpg" alt="">
                </div>
                <div class="caus-info row no-margin">
                    <span class="left-info col-6">
                        RAISED: $764
            ...
            <div class="col-md-3">
                ...
                <div class="caus-img">
                    <img src="public/images/causes/c3.jpg" alt="">
                </div>
                <div class="caus-info row no-margin">
                    <span class="left-info col-6">
                        RAISED: $764
